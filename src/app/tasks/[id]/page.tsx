            ...
            <PageShell
              ...
              darkSection={(
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    <div className="text-sm text-gray-300 mb-1">Posted</div>
                    <div className="text-base font-medium border-b border-gray-700 pb-2">{formatDistanceToNow(new Date(task.created_at))}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-300 mb-1">Location</div>
                    <div className="text-base font-medium border-b border-gray-700 pb-2">{task.location || 'Remote'}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-300 mb-1">Category</div>
                    <div className="text-base font-medium border-b border-gray-700 pb-2">{task.category || '—'}</div>
                  </div>
                </div>
              )}
            >
