  ...
  return (
    <div className="min-h-[100svh] bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <PageShell
          header={<h1 className="text-2xl font-bold text-gray-900 text-center">Notifications</h1>}
          darkSection={<p className="text-sm text-gray-300">Your latest updates appear here.</p>}
        >
