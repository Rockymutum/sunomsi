...
export default function TaskCard({ task }: TaskCardProps) {
  ...
  return (
    ...
    >
      {/* Posted by - Instagram style header */}
      ...
      <div className="px-6 py-5 sm:px-8 sm:py-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* Budget */}
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 border border-emerald-200 rounded-2xl p-2">
            ...
            <div className="text-xl font-bold text-emerald-900">₹{task.budget}</div>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-2">
            ...
            <div className="text-xs font-semibold text-slate-900 truncate">{task.location}</div>
          </div>
        </div>
